<template>
  <nav>
    <v-app-bar app color="primary">
      ...
      <v-spacer></v-spacer>
      <v-btn text color="white" @click="auth.logout()">
        <span>Atslēgties</span>
...
export default {
  data() {
    return {
      ...
      router,
      links: [
        { text: "Statistika", route: "/" },
        { text: "Pievienot failu", route: "/add-file" },
        { text: "Gatavi templeiti", route: "/custom-premade" },
        { text: "Izveidot atskaņošanas sarakstu", route: "/add-playlist" },
