    ...
    <v-row align="center" justify="center">
      <v-col cols="11" md="7">
        <div class="text-center mb-15">
          ...
          <p>
            Šajā ekrānā tiek atspoguļoti visi TV, kuri šobrīd darbojās, kā arī
            atskaņošanas saraksti, kas šobrīd tiek attēloti
          </p>
          <p>
            <small>
              ja TV neatbalsta nepieciešamo funckiju, pogas "ieslēgt"/"izslēgt"
              var nedarboties
            </small>
          </p>
        </div>
          ...
          <template v-if="item.tvStatus">
            ...
            <v-card-actions class="justify-center">
              <v-btn
                color="teal accent-3"
                dark
                @click="controlTv(false, item._id)"
              >
                IZSLĒGT
              </v-btn>
            </v-card-actions>
